...
{{--                    </th>--}}
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{$item->image?$item->image: asset('admin/dist/img/difulte/avatar.jpg')}}" style="width: 100px">
                        </td>
                        <td>
                            {{$item->phone}}
                        </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content bg-danger">
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <form action="{{ route('user_destroy', $item->id)}}" method="post" class="px-0 mx-0" id="form">
                                                    @csrf
                                                    @method('DELETE')
