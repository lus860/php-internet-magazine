        ...
        <section class="content">
            <div class="row ">
                ...
                <div class="col-md-9 mx-auto">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName"
                                       ...
                                       value="{{ old('phone') }}" name="phone" placeholder="{{ __('user.phone') }}">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="inputName"
                                       ...
                                       value="{{ old('email') }}" name="email" placeholder="{{ __('user.email') }}">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <!-- /.card -->
                    <div>
                        <input type="submit" value="{{ __('user.new_user_create') }}"
