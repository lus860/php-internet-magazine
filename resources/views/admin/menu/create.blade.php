    ...
    <section class="content">
        <div class="row ">
            ...
            <div class="col-md-9 mx-auto">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" class="form-control  @error('name') is-invalid @enderror" value="{{ old('name') }}" name="name" placeholder="{{ __('menu.menu_name') }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="parent_id">
                                <option selected="selected" disabled>{{ __('menu.select_parent_menu_item') }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="inputName" class="form-control  @error('url') is-invalid @enderror" value="{{ old('url') }}" name="url" placeholder="{{ __('menu.menu_url') }}">
                            @error('url')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <!-- /.card -->
                <div>
                    <input type="submit" value="{{ __('menu.new_menu_create') }}" class="btn btn-success float-right">
                </div>
            </div>
        </div>
    </section>
