<div class="container">
    <div class="breadcrumbs">
        <ol class="breadcrumb">
            <li><h3 id="getTotalQty">Qty: {{\Cart::session(session('cart_id'))->getTotalQuantity()}} </h3></li>
            <br>
                ...
                <tr>
                    ...
                    <td class="cart_quantity">
                        <div class="cart_quantity_button">
                            ...
                            <input class="cart_quantity_input" type="text" name="quantity" value="{{$row->quantity}}"
                                   autocomplete="off" size="2">
                            <a class="cart_quantity_down" href="{{ route('update_down_cart',['id'=>$row->id]) }}">
                                - </a>
                        </div>
                    </td>
                    <td class="cart_total">
                    ...
                    <td class="cart_delete">
                        <a class="cart_quantity_delete" href="{{ route('remove_cart',['id'=>$row->id]) }}"><i
