                    ...
                    <tr>
                        ...
                        <td class="cart_quantity">
                            <div class="cart_quantity_button">
                                ...
                                <input class="cart_quantity_input" type="text" name="quantity" value="{{$row->quantity}}" autocomplete="off" size="2" data-id="{{$row->id}}">
                                <a class="cart_quantity_down" href="{{ route('update_down_cart',['id'=>$row->id]) }}"> - </a>
                            </div>
                        </td>
                        <td class="cart_total">
                            <p class="cart_total_price" id="{{$row->id}}">${{ \Cart::get($row->id)->getPriceSum() }}</p>
                        </td>
                ...
                <div class="category-tab"><!--category-tab-->
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs">
                            @guest
                            <li class="active"><a class="cart-tab" href="#guest_checkout" data-toggle="tab" data-href="guest_checkout">Guest Checkout</a></li>
                            <li><a class="cart-tab" href="#register_account" data-toggle="tab" data-href="register_account">Register Account</a></li>
                            <li><a href="{{ route('user_login') }}">Authorize</a></li>

                            @else
                                <li class="active"><a class="cart-tab" href="#logged_user" data-toggle="tab" data-href="guest_checkout">Logged User</a></li>
                            @endguest
                        </ul>
                    </div>
                                ...
                                <form method="POST" action="{{ route('order_signup') }}">
                                    ...
                                    <div class="form-group has-feedback">
                                        <input id="firstname" type="text"
                                               ...
                                               name="guest_firstname" value="{{ old('guest_firstname') }}" autocomplete="firstname"
                                    ...
                                    <div class="form-group has-feedback">
                                        <input id="lastname" type="text"
                                               ...
                                               name="guest_lastname" value="{{ old('guest_lastname') }}" autocomplete="lastname"
                                    ...
                                    <div class="form-group has-feedback">
                                        <input type="email" class="form-control @error('guest_email') is-invalid @enderror"
                                               name="guest_email" value="{{ old('guest_email') }}" autocomplete="email"
                                    ...
                                    <div class="form-group has-feedback">
                                        <input type="text" class="form-control @error('guest_address') is-invalid @enderror"
                                               name="guest_address" value="{{ old('guest_address') }}" autocomplete="email"
                                    ...
                                    <div class="form-group has-feedback">
                                        <input type="text" class="form-control @error('guest_phone') is-invalid @enderror"
                                               name="guest_phone" value="{{ old('guest_phone') }}" autocomplete="email"
                                    ...
                                    <button type="submit" class="btn btn-success">{{ __('auth.sign_up') }}</button>
                                </form>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="tab-pane fade active in" id="logged_user">
                                <div class="col-sm-6">
                                    <form method="POST" action="{{ route('order_logged') }}">
                                        ...
                                        <div class="form-group has-feedback">
                                            <input type="text" class="form-control @error('address') is-invalid @enderror"
                                                   name="address" value="{{ Auth::user()->address?? old('address') }}" autocomplete="email"
                                                   placeholder="{{ __('auth.address') }}">
                                            @error('address')
                                            <span class="invalid-feedback" role="alert">
                                        <strong style="color:red">{{ $message }}</strong>
                                        ...
                                        <div class="form-group has-feedback">
                                            <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                                   name="phone" value="{{ Auth::user()->phone?? old('phone')}}" autocomplete="phone"
                                                   placeholder="{{ __('auth.phone') }}">
