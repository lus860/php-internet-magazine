...
@section('content')
    <form method="POST" action="{{ route('menu_update',$menu->id) }}" class="content">
        @csrf
                ...
                <div class="col-md-9 mx-auto">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('menu.edit_menu') }}</h3>
                    ...
                    <!-- /.card -->
                    <div>
                        <input type="submit" value="{{ __('menu.edit_menu') }}" class="btn btn-success float-right">
                    </div>
                </div>
            </div>
        </section>
