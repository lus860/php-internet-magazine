                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-footer">
                        <div class="" style="margin-top: 10px">
                            <a class="dropdown-item nav-link" href="{{ route('profile') }}"><i class="fas fa-cog m-r-5 m-l-5"></i> {{ __('app.profile_settings') }}</a>
                        </div>
                        <div class="" style="margin-top: 10px">
                            <a href="/" class="dropdown-item nav-link"><i class="fa fa-home m-r-5 m-l-5"></i>  {{ __('app.view_site') }}</a>
                        </div>
                        <div class="" style="margin-top: 10px">
...
<!-- jQuery -->
<script src="{{ asset('admin/dist/js/jquery.jquery.dataTables.min.js') }}"></script>
