...
@section('content')
    <form method="POST" action="{{ route('product_update',$product->id) }}" class="content"
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="brand_id">
                                        ...
                                        @foreach($brands as $item)
                                            <option value="{{$item->id}}"
                                                    @if($product->brand->id == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="subcategory_id">
                                        ...
                                        @foreach($subcategories as $item)
                                            <option value="{{$item->id}}"
                                                    @if($product->sub_category && $product->sub_category->id == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" id="inputName"
                                           ...
                                           value="{{$product->new_price?$product->new_price:0}}" name="new_price"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="category_id">
                                        ...
                                        @foreach($categories as $item)
                                            <option value="{{$item->id}}"
                                                    @if($product->category->id == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="customSwitch4"
                                                   name="status" @if($product->status == 1) checked @endif>
                                            <label class="custom-control-label"
                                                   for="customSwitch4">{{ __('product.product_status_change') }}</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="customSwitch3"
                                                   name="sale" @if($product->sale == 1) checked @endif>
                                            <label class="custom-control-label"
                                                   for="customSwitch3">{{ __('product.product_sale_change') }}</label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div
                                            ...
                                            <input type="checkbox" class="custom-control-input" id="customSwitch5"
                                                   name="active" @if($product->active == 1) checked @endif>
                                            <label class="custom-control-label"
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-toggle="modal"
                                        data-target="#modal-success-{{$img->id}}" data-value="{{$img->id}}">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button type="button" data-toggle="modal" data-target="#modal-danger-{{$img->id}}"
                                        data-value="{{$img->id}}" class="btn btn-tool"><i class="fas fa-times"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content bg-success">
                            ...
                            <div class="modal-footer justify-content-between">
                                <form
                                    action="{{ route('image_update', ['prod_id' => $product->id, 'img_id' =>$img->id])}}"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content bg-danger">
                            ...
                            <div class="modal-footer justify-content-between">
                                ...
                                <form
                                    action="{{ route('image_destroy', ['prod_id' => $product->id, 'img_id' =>$img->id])}}"
