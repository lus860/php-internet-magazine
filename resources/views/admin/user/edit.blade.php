                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName"
                                       ...
                                       value="{{$user->phone}}" name="phone" placeholder="{{ __('user.phone') }}">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputName"
                                       ...
                                       value="{{$user->address}}" name="address" placeholder="{{ __('user.address') }}">
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="inputName"
                                       class="form-control  @error('email') is-invalid @enderror"
                                       value="{{$user->email}}" name="email" placeholder="{{ __('user.email') }}">
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" type="password"
                                       ...
                                       value="{{$user->password}}" name="password" autocomplete="new-password"
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input id="password-confirm" type="password" class="form-control"
                                       ...
                                       autocomplete="new-password" placeholder="{{ __('user.password_confirmation') }}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="role">
                                    ...
                                    @foreach($role as $k => $item)
                                        <option value="{{$item}}" name="role"
                                                @if($item == $user->role) selected @endif >{{ $k }}</option>
                                    @endforeach
                                </select>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text"
                                           class="form-control @error('email_verified_at') is-invalid @enderror datetimepicker-input"
                                           data-target="#reservationdate" name="email_verified_at"
